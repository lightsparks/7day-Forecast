const app = new Vue({
    ...
    mounted: function () {
        ...
        axios.get("https://api.openweathermap.org/data/2.5/onecall?lat=52.231589&lon=5.189039&exclude=minutely,hourly&units=metric&appid=d1e902b667baccdb37cfbc96ad629f00")
            .then((response) => {
                this.currentWeather = {
